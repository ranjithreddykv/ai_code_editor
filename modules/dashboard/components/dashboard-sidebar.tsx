          ...
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip="Dashboard"
              >
                <Link href="/dashboard" className="flex flex-row gap-3">
                ...
                starredPlaygrounds?.map((playground) => {
                  ...
                  return (
                    <SidebarMenuItem key={playground.id}>
                      ...
                      >
                        <Link className="flex flex-row gap-3 " href={`/playground/${playground.id}`}>
                          {IconComponent && (
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild tooltip="Settings">
              <Link href="/settings" className="flex flex-row gap-3 items-center">
